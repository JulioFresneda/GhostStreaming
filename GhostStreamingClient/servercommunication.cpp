...
std::vector<std::string> ServerCommunication::GetUsers(std::string url, std::string clientName) {
    CURL *curl;
    CURLcode res;
...
std::vector<std::string> ServerCommunication::AddUser(std::string url, std::string clientName, std::string newUsername) {
    CURL *curl;
    CURLcode res;
    std::string readBuffer;
    std::vector<std::string> user_list;
    ...
    // Your JSON data
    std::string jsonData = "{\"clientName\":\"" + clientName + "\", \"userName\":\"" + newUsername + "\"}";
